            ...
            <div class="w-full md:w-1/2 ">
                ...
                <form action="" class="flex flex-col gap-4">
                    <div>
                        ...
                        <input v-model="formData.fullName"  class="w-full border-gray-200 px-4 py-2 focus:outline-none" type="text" name="name" placeholder="Write your name">
                    </div>

                    <div>
                        <label class="text-gray-500 inline-block pb-2" for="email">Email</label>
                        <input v-model="formData.email" class="w-full border-gray-200 px-4 py-2 focus:outline-none" type="email" name="email" placeholder="Write your email">
                    </div>
                    <div>
